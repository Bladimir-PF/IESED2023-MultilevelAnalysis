...
En particular, el conjunto de entrenamiento estuvo constituido por 72.968 postulantes pertenencientes a xxxx colegios. El conjunto de validación estuvo constituido por 74.594 casos distribuidos en xxxx colegios.
...
tabl <- "
|		|	Pendiente	|	Pendiente estandarizada	|	SE	|	Pr(>|t|)	|
|:------|:--------:|:--------:|:------:|:-------:|
...
En relación con la pregunta de investigación, preliminarmente podemos concluir que:
